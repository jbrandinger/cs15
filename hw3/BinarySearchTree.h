...
private:
        ...
        void   rootDelete();
        bool   noChildren(Node *toRemove);
        void   noChildRemoval(Node *toRemove, Node *parent);
        bool   oneChild(Node *toRemove);
        void   oneChildRemoval(Node *toRemove, Node *parent);
        void   twoChildRemoval(Node *toRemove);
